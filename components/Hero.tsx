    ...
    <div className='pb-20 pt-36'>
      ...
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black-100 bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"/>
       ...
       <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          ...
          <TextGenerateEffect 
            ...
            words="Transforming ideas into real solutions."
          />
          <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
            Hi, I&apos;m Jacob. I am a  Next.js Developer based in Los Angeles, California.
          </p>
          <a href='#about'>
            <MagicButton 
            title="Show my work"
